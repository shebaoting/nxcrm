...
class CrmOpportunitys extends Bar
{
    ...
    protected function init()
    {
        ...
        $opportunity = DB::table('crm_opportunitys');
...
HTML
    ...
    {
        $origin = DB::table('crm_opportunitys')->selectRaw('DATE_FORMAT(created_at,"%Y-%m") as date,SUM(expectincome) as value')
            ->whereMonth('created_at', date('m'))
            ->groupBy('date')
            ->get()
            ->toArray();

        $last_month = DB::table('crm_opportunitys')->selectRaw('DATE_FORMAT(created_at,"%Y-%m") as date,SUM(expectincome) as value')
