...
class CrmContracts extends Bar
{
...
HTML
     ...
     */
     ...
     public function grow (){
        $origin = DB::table('crm_contracts')->selectRaw('DATE_FORMAT(signdate,"%Y-%m") as date,COUNT(*) as value')
        ->whereMonth('signdate', date('m'))
        ->groupBy('date')
        ->get()
        ->toArray();

        $last_month = DB::table('crm_contracts')->selectRaw('DATE_FORMAT(signdate,"%Y-%m") as date,COUNT(*) as value')
